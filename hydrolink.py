...
def exibir_opcoes():
    print('1. Poluiçoes dos Continentes', '2. Contribuiçoes dos Continentes com meio ambiente', '3. Sobre', '4. Sair\n', sep='\n')

def exibir_continentes():
    print('\n1. America do Sul', '2. America do Norte', '3. Africa', '4. Europa', '5. Asia', '6. Oceania', '7. Sair\n', sep='\n')

def exibir_anos():
    print('1. 2021', '2. 2022', '3. 2023', '4. 2024', '5. futuro', sep='\n')
...
def ano_europa_poluicao():
    ...
    try:
        ...
        if opcao_escolhida == 1:
           print('''*2021*
                 Em 2021, os oceanos que banham a Europa, especialmente o Atlântico e o Mediterrâneo, enfrentaram sérios problemas de poluição por plásticos, produtos químicos e resíduos industriais. Países como Espanha, França e Itália registraram altos níveis de poluentes nas águas costeiras. A União Europeia intensificou suas políticas de redução de plásticos de uso único. Iniciativas de limpeza e campanhas de conscientização ganharam força. A presença de microplásticos na vida marinha e nos alimentos foi uma grande preocupação.
''')
        elif opcao_escolhida == 2:
           print('''*2022*
No ano de 2022, a poluição oceânica na Europa continuou a ser um problema crítico, com foco crescente na redução de resíduos plásticos. Programas de reciclagem foram ampliados e campanhas de sensibilização ambiental foram intensificadas. A poluição por resíduos farmacêuticos e químicos industriais recebeu maior atenção. A União Europeia introduziu novas regulamentações ambientais para proteger as águas costeiras. Projetos de monitoramento e limpeza do Mediterrâneo começaram a mostrar resultados positivos.
''')
        elif opcao_escolhida == 3:
           print('''*2023*
...
''')
           ...
           print('''*2024*
Em 2024, a poluição dos oceanos na Europa continuou a ser monitorada de perto, com avanços em várias frentes. A implementação de biotecnologias para a degradação de plásticos e a promoção de materiais biodegradáveis começaram a mostrar resultados promissores. As políticas de gestão de resíduos foram reforçadas, especialmente em áreas urbanas costeiras. A educação ambiental nas escolas e universidades foi ampliada para aumentar a conscientização sobre a proteção dos oceanos. A União Europeia continuou a liderar iniciativas globais de proteção marinha
''')
        elif opcao_escolhida == 5:
           print('''*Futuro*
Para o futuro, espera-se que a poluição dos oceanos na Europa seja abordada de forma mais eficaz através de uma combinação de políticas rigorosas, inovações tecnológicas e educação ambiental. A transição para uma economia circular será essencial para reduzir a geração de resíduos. A colaboração entre governos, indústrias e ONGs será crucial para implementar soluções sustentáveis. A pesquisa contínua sobre os impactos da poluição e as melhores práticas de mitigação informará políticas públicas mais eficazes. A proteção dos ecossistemas marinhos será uma prioridade contínua para garantir a saúde dos oceanos.
''')
        else:
           opcao_invalida()
    except:
...
''')
           ...
           print('''*2024*
Em 2024, a ajuda internacional focou em soluções sustentáveis e de longo prazo para a poluição marinha na Europa. Novas tecnologias de biodegradação de plásticos e materiais alternativos foram amplamente adotadas. Investimentos em infraestrutura de saneamento e tratamento de águas residuais foram priorizados, especialmente em áreas urbanas costeiras. A cooperação regional foi intensificada através de conferências e fóruns sobre sustentabilidade marinha. Programas de educação ambiental foram expandidos para aumentar a conscientização pública sobre a importância da preservação dos oceanos.''')
        elif opcao_escolhida == 5:
           print('''*Futuro*
Para o futuro, espera-se que a ajuda internacional continue a ser crucial na luta contra a poluição dos oceanos na Europa. A implementação de políticas ambientais rigorosas e a transição para uma economia circular serão fundamentais. Inovações tecnológicas em gestão de resíduos e monitoramento ambiental serão essenciais para reduzir a poluição marinha. A educação e a conscientização pública permanecerão vitais para promover práticas sustentáveis. A colaboração entre governos, ONGs e o setor privado será crucial para alcançar soluções eficazes e duradouras.''')
        else:
           opcao_invalida()
    except:
        opcao_invalida()
